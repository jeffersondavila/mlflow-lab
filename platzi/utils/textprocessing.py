...
class TextProcessing:
    ...
    def run(self, file_name: str, version: int):
        ...
        PATH_DATA_RAW = str(BASE_DIR / "tracking" / "data" / "data_raw")
        PATH_DATA_PROCESSED = str(BASE_DIR / "tracking" / "data" / "data_processed")
        Path(PATH_DATA_PROCESSED).mkdir(parents=True, exist_ok=True)  # garantiza que exista
